...
#
# messages = [
#     SystemMessage(content="You are an expert systems programmer. Explain concepts concisely."),
#     HumanMessage(content="What is the difference between a mutex and a semaphore?")
# ]
#
